...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php echo form_open_multipart('admin/Paciente/Update/' .$usuario->id_usuario. query_string('?')) ?>
            ...
            <?php echo $this->mensagem->exibirTodas() ?>
                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Alterar paciente</h3>
                        <div class="box-tools pull-right">
                            ...
                            <ul class="dropdown-menu pull-right margin-right-10">
                                ...
                                <?php if($this->acesso->podeAcessar('admin/Paciente/permissoesEspeciais')): ?>
                                <!-- <li>
                                    <a href="<?php echo base_url('admin/Paciente/permissoesEspeciais/'. $usuario->id_usuario) ?>"><i class="fa fa-unlock"></i> Permissões </a>
                                </li> -->
                                <?php endif ?>

                                <?php if($this->acesso->podeAcessar('admin/Paciente/update_senha')): ?>
                                <li>
                                    <a href="<?php echo base_url('admin/Paciente/update_senha/'.$usuario->id_usuario) ?>"><i class="fa fa-key"></i> Alterar senha </a>
                                </li>
                                <?php endif ?>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="checkbox">
                                            <label class="sys-label-ckeck-dependente">
                                                <?php echo  booleanCheckbox('is_dependente', 1, set_value('is_dependente', ($usuario->responsavel_id) ? 1 : 0 )); ?>sim
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sys-find-dependente" style="display: none">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="custom-select-2">
                                                <select name="responsavel_id" id="autocomplete-resposavel" class="form-control autocomplete custom-select-2" data-url="<?php echo base_url('admin/Paciente/find'); ?>">
                                                    <option value="<?php echo $responsavel->id_usuario  ?>"><?php echo  $responsavel->nm_usuario ?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="grau_parentesco_responsavel"  value="<?php echo set_value('grau_parentesco_responsavel', $usuario->grau_parentesco_responsavel) ?>">
                                        </div>
                                    </div>
                                    <hr>
...
<!-- /////////////////////////////////////////////////////////////////////////////// -->
                    ...
                    <div class="box-footer">
                        <a type="submit" href="<?php echo base_url('admin/Paciente') ?>" class="btn btn-default">Cancelar</a>
