    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <?php echo $this->mensagem->exibirTodas() ?>
                <!-- form -->
                <?php echo form_open_multipart('admin/Permissao/create' .'/'. query_string('?')) ?>
                    <div class="box">
                        <!-- box-header -->
                        ...
                        <div class="box-body form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input class="form-control" type="text" name="nm_permissao"  value="<?php echo set_value('nm_permissao') ?>">
								</div>
							</div>
