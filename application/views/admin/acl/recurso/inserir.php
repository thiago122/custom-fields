    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <!-- form -->
                <?php echo form_open_multipart('admin/recurso/create' .'/'. query_string('?')) ?>
                    <div class="box">
                        <!-- box-header -->
                        <div class="box-header with-border">
                            <h3 class="box-title">Adicionar recurso</h3>
                        </div><!-- /box-header -->
                        <!-- box-body -->
                        <div class="box-body form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select name="fk_permissao" class="form-control">
										...
										<?php echo  option_dropdown($permissao, array('id_permissao','nm_permissao'), set_value( 'fk_permissao') ) ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input class="form-control" type="text" name="nm_recurso"  value="<?php echo set_value('nm_recurso') ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input class="form-control" type="text" name="action"  value="<?php echo set_value('action') ?>">
								</div>
							</div>
