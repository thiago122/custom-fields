...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php echo form_open_multipart('admin/Profissional/Update/' .$usuario->id_usuario. query_string('?')) ?>
                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Alterar médico</h3>
                        <div class="box-tools pull-right">
                            ...
                            <ul class="dropdown-menu pull-right margin-right-10">
                                ...
                                <?php if($this->acesso->podeAcessar('admin/Profissional/permissoesEspeciais')): ?>
                                <!-- <li>
                                    <a href="<?php echo base_url('admin/Profissional/permissoesEspeciais/'. $usuario->id_usuario) ?>"><i class="fa fa-unlock"></i> Permissões </a>
                                </li> -->
                                <?php endif ?>

                                <?php if($this->acesso->podeAcessar('admin/Profissional/update_senha')): ?>
                                <li>
                                    <a href="<?php echo base_url('admin/Profissional/update_senha/'.$usuario->id_usuario) ?>"><i class="fa fa-key"></i> Alterar senha </a>
                                </li>
                                <?php endif ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" type="text" name="crm"  value="<?php echo set_value('crm', $profissional->crm) ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" type="text" name="faculdade"  value="<?php echo set_value('faculdade', $profissional->faculdade) ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" type="text" name="residencia"  value="<?php echo set_value('residencia', $profissional->residencia) ?>">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php foreach($especialidades as $especialidade): ?>
                                    <?php $checked = ( $especialidade->checked )? ' checked="checked" ': '' ?>
                                    <div class="checkbox">
                                        <label>
                                            <input name="especialidades[]" type="checkbox" value="<?php echo $especialidade->id_especialidade ?>" <?php echo $checked ?> >
                                            <?php echo $especialidade->nm_especialidade ?>
                                        </label>
                                    </div>
                                <?php endforeach; ?>
