...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php echo form_open_multipart('admin/usuario/store/'. query_string('?')) ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="fk_nivel" class="form-control">
                                            <option value=""> Escolha </option>
                                            <?php echo option_dropdown($niveis, array('id_nivel','nm_nivel'), set_value( 'fk_nivel') ) ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="checkbox">
                                            <label>
                                                <?php echo  booleanCheckbox('usuario_ativo', 1, set_value('usuario_ativo')); ?>Ativo
                                            </label>
                                        </div>
                                    </div>
                                </div>
